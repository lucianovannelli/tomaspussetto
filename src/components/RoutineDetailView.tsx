    ...
    <section className="space-y-4">
      ...
      {basicMode ? (
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          <button 
            type="button" 
            className="w-10 h-10 rounded-2xl border border-[#e6dfd5] bg-[#faf7f2]/80 hover:bg-[#ede6dc] text-[#5e4e43] hover:text-[#26160d] flex items-center justify-center transition active:scale-95 shadow-xs shrink-0 cursor-pointer" 
